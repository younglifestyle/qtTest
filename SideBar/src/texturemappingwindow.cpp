...
{
    QImage image(":/images/resources/Tim.bmp");
...
void TextureMappingWindow::loadShader()
{
    ...
    m_program->addShaderFromSourceFile(QOpenGLShader::Vertex, ":/images/shader/vertshader.glsl");
    m_program->addShaderFromSourceFile(QOpenGLShader::Fragment, ":/images/shader/fragshader.glsl");
    m_program->link();
